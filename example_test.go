...
func ExampleParseFunction() {
	...
	// Output:
	// {"name":"NewWidgetFactory","description":"NewWidgetFactory creates a new widget factory.","parameters":{"type":"object","properties":{"factoryInfo":{"type":"object","properties":{"Category":{"type":"string","enum":["foo","bar"]},"FactoryName":{"type":"string"},"InventoryLevels":{"type":"array","items":{"type":"integer"}},"Operational":{"type":"boolean"}}}},"required":["factoryInfo"]}}
}
